      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-stretch">
        ...
        >
          <GlowCard className="h-full p-8 flex flex-col items-center justify-center text-center">
            {/* Profile Image */}
            <div className="w-56 h-56 rounded-full bg-gradient-to-br from-primary to-accent mb-6 flex items-center justify-center overflow-hidden shadow-[0_0_30px_rgba(46,107,255,0.3)] border-4 border-white mx-auto">
